<%-- 
    Document   : VieEngForAdmin
    Created on : Mar 14, 2023, 4:54:02 PM
    Author     : Peanut
--%>
        ...
        <main>
            ...
            <form action="detail?acc=${u.getAccount()}" method="post">
                ...
                <div>
                    ...
                    <input class="adminFunction" id="detail" type="submit" name="detail2" value="Detail">
                    <input class="adminFunction" id="delete" type="submit" name="delete2" value="Delete Word">
                    <input class="adminFunction" id="showComment" type="submit" name="showComment" value="Show User's Comment">
