<%-- 
    Document   : EngVie
    Created on : Mar 3, 2023, 4:26:40 PM
    Author     : Peanut
--%>
    ...
    <body>
        <header>
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="dictionary?mod=3&acc=${u.getAccount()}">Search History</a></li>
        ...
        <main>
            ...
            <form id="form1" action="dictionary?acc=${u.getAccount()}" method="post">
                ...
                <input type="submit" id="searchButton" name="searchSubmit" value="Search"><br>
            </form>
            <div id="wordNotExist">
                ${wordNotExist}
            </div>
